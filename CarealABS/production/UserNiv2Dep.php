<?php 
    ...
    $dep=depart($_SESSION['Departement']);
?>
<!DOCTYPE html>
<html lang="en">
  <head>
                      ...
                      echo "
                        <div class='col-md-3 col-md-offset-4'>
                            ...
                            <div class='thumbnailok text-center'>
                              <div class='captionok'>
                                <h1>Département : ".$dep['NomDep']."</h1>
                                <h4>".$dep['NbEmp']." Employés</h4>
                                <h4>".$dep['NbServ']." Services</h4>
                                <a class='btnok more' href='#' id='".$_SESSION['Departement']."' style='border-radius: 15px 50px 30px;background-color:#03C9A9;'>more</a>
                              </div>
                              </div>
                            </div>
                          </div>
