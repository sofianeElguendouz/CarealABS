<?php
    ...
    $mois=$date[0].'-'.$date[1];
    $dataPoints1=tableHistoMoisServ($_SESSION['Service'],$mois);
    $dataPoints2=tableHeuresAbsServ($_SESSION['Service'],$mois);
    $dataPoints3=tableHistoMoisTauxAbsServ($_SESSION['Service'],$mois);
    $notifTauxAbs=notifTauxAbsServ($mois,$_SESSION['Service']);
    $e=EmpPlus($mois,$_SESSION['Service']);
    /*---------------------------------------------*/
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <body class="nav-md">
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="row tile_count">
            <div class="col-md-5 col-sm-4 col-xs-6 tile_stats_count col-md-offset-4">
              <span class="count_top"><i class="fa fa-user"></i> Nombre Employés Total Dans Le Service</span>
              <div class="count green"><?php echo totalNumberEmployesServ($_SESSION['Service']); ?></div>
            </div>
          </div>
                    ...
                    <button id="myBtn0" class="btnNotif"><span class="glyphicon glyphicon-triangle-top red"></span></button>
                            <div id="myModal0" class="modal">
                              <div class="modal-content">
                                ...
                                <p><?php 
                                        if ($notifTauxAbs>0) {echo "Le Taux D'absence Général Dans Le Service a Augmenté de ".$notifTauxAbs." %";} 
                                        else echo "Le Taux D'absence Général Dans Le Service N'a Pas Augmenté";
                                    ?>
                                </p>
                              </div>
                            </div>
                    ...
                    <button id="myBtn1" class="btnNotif"><span class="glyphicon glyphicon-triangle-bottom green"></span></button>
                            <div id="myModal1" class="modal">
                              <div class="modal-content">
                                <span class="close">&times;</span>
                                <p><?php 
                                        if ($notifTauxAbs<0) {echo "Le Taux D'absence Général Dans Le Service a Diminué de ".$notifTauxAbs." %";} 
                                        else echo "Le Taux D'absence Général Dans Le Service N'a Pas Diminué";
                                    ?>
                                </p>
                              </div>
                            </div>  
                    ...
                    <button id="myBtn2" class="btnNotif"><span class="glyphicon glyphicon-warning-sign text-warning"></span></button>
                            <div id="myModal2" class="modal">
                              <div class="modal-content">
                                <span class="close">&times;</span>
                                <p><?php 
                                        echo "L'employé Ayant Le Plus Grand Taux D'absence Est : ".$e;
                                    ?>
                                </p>
                              </div>
                            </div>  
          ...
          <br><br><br><br>
          <div id="chartContainer3" style="width: 45%; height: 400px;display: inline-block;" class="col-md-offset-3"></div>
    ...
    <script type="text/javascript">
        ...
        var options = {
        title: {
          text: "Total Heures Perdu Pour Le Service Pour Chaque Jour De Ce Mois",
          fontColor: "#2f4f4f",
          fontSize: 20,
          padding: 10,
          margin: 15,
      ...
      $(function () {
          var options = {
            title: {
              text: "Evolution Taux De Présence Dans Le Serivce Pour Ce Mois",
              fontColor: "#2f4f4f",
              fontSize: 20,
              padding: 10,
              margin: 15,
        ...
        $(function () {
          var options = {
            title: {
              text: "Evolution Taux D'absence Pour Ce Mois",
              fontColor: "#2f4f4f",
              fontSize: 20,
              padding: 10,
              margin: 15,
