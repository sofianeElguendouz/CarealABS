<?php
      ...
      $serv_dep=select_services_departement($_SESSION['Departement']);
?>
<!DOCTYPE html>
<html lang="en">
  <head>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-desktop"></i> Hièrarchie <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="#">Structure Administration</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
                      ...
                      echo "
                        <div class='col-md-3'>
                          ...
                          <div class='thumbnailok text-center'>
                            <div class='captionok'>
                              <h1>".$serv_dep[$i]['Service']."</h1>
                              <h4>".$serv_dep[$i]['nb']." Employés</h4>
                              <a class='btnok' id='".$serv_dep[$i]['Num']."' style='border-radius: 15px 50px 30px;background-color:#03C9A9' >More</a>
                            </div>
                            </div>
                          </div>
                        </div>
