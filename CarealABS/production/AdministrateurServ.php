...
$query = $bdd->query('SELECT * FROM services');
...
$admin->addService($_POST['Nom'],$_POST['Dep']);
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="#" class="site_title"><i class="fa fa-paw"></i> <span>Abscence</span></a>
            </div>
        ...
        <div class="right_col" role="main">
          <div class="row tile_count">
              ...
              <div class="modal_bg">
                <div id="modal_main">
                  <img src="images/icon-close-128.png" class="closer">
                      <form method = "POST" class="form"  >
                            <label>Nom du service : </label><input type = "text"  placeholder = "Nom du service" class="Nom" name ="Nom"/>
                            <label>Departement associé : </label>
                              <select class="Departement" name="Dep">
                                      <?php
                                      $bdd = new PDO('mysql:dbname=project;localhost=localhost','root','');
                                      ...
                                      {
                                        echo "  <option value=".$v->Id.">".$v->Departement."</option>        ";
                                      }
              ...
              <div class="text-center"><button class="btn btn-success " id ="myBtn"><h1>Ajouter Service</h1></button></div>
              <table class="table" style="width:700px;margin:auto;margin-top:150px;">
                  <thead>
                    <tr style="color: #AE5553">
                      <td><h2>Numero du service</h2></td>
                      <td><h2>Nom du service</h2></td>
                    </tr>
                  </thead>
                  <tbody>
                   <?php $i=1;foreach($services as $v)
                   {

                    echo '<tr name="'.$v->Service.'">
                          <td>'.$i.'</td>
                          <td>'.$v->Service.'</td>
                          <td> 
                           <button class="btn btn-danger supprimer" title="'.$v->Num.'">Supprimer</button>
                          </tr>';
                          $i++;
                   }
                   ?>
