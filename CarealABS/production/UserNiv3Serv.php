                      ...
                      echo "
                        <div class='col-md-3 col-md-offset-4'>
                          ...
                          <div class='thumbnailok text-center'>
                            <div class='captionok'>
                              <h1>Service : ".$s['NomServ']."</h1>
                              <h4>".$s['NbEmp']." Employés</h4>
                              <a class='btnok more' id='".$_SESSION['Service']."' style='border-radius: 15px 50px 30px;background-color:#03C9A9' >More</a>
                            </div>
                            </div>
                          </div>
                        </div>
